            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="about-content" data-aos="fade-up" data-aos-duration="1100">
                        ...
                        <nuxt-link to="/donation" class="btn-theme btn-gradient btn-slide">Donate Now <img class="icon icon-img" src="/images/icons/arrow-line-right2.png" alt="Icon"></nuxt-link>
                    </div>
                </div>
            </div>
        </div>
